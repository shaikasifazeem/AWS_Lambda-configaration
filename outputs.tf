...
output "lambda_invocation_alarm_names" {
  value       = [for k, v in aws_cloudwatch_metric_alarm.lambda_invocations : v.alarm_name]
  description = "A list of all Lambda invocation alarm names"
}
